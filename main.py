...
def transition():
    ...
    windowt = Window(1100, 650)
    windowt.set_background_color((0,0,0))

    timer = 0.0
    

    while (timer<1.0) and (timer>=0.0):
        if (timer>=0.0) and (timer<0.5):
